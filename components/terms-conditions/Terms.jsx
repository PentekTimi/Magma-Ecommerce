...
export default function Terms () {
    return (
    <div>
        <div className={TermStyles.titleContainer}>
            <div className={TermStyles.container}>
                <h2 className={TermStyles.title}>Terms and Conditions</h2>
                <p className={TermStyles.updateData}>Last updated July 17, 2023</p>
            </div>
        </div>
        <div className={TermStyles.container}>
            <div className={TermStyles.legalContent}>
                <div className={TermStyles.legalSections}>
                    ...
                    <p>The Services are intended for users who are at least 13 years of age. All users who are minors in the jurisdiction in which they reside (generally under the age of 18) must have the
                        ...
                        prior to you using the Services.</p>
                    <p>We recommend that you print a copy of these Legal Terms for your records.</p>
                </div>
                <div className={TermStyles.legalSections}>
                    <h3>1. OUR SERVICES</h3>
                    <p>The information provided when using the Services is not intended for distribution to or use by any person or entity in any jurisdiction or country where such distribution or use would be
                    contrary to law or regulation or which would subject us to any registration requirement within such jurisdiction or country. Accordingly, those persons who choose to access the Services
                    from other locations do so on their own initiative and are solely responsible for compliance with local laws, if and to the extent local laws are applicable.</p>
                </div>
                <div className={TermStyles.legalSections}>
                    ...
                    posted, publicly displayed, encoded, translated, transmitted, distributed, sold, licensed, or otherwise exploited for any commercial purpose whatsoever, without our express prior written
                    permission.
                    </p>
                    <p>
                    ...
                    contact@magma.com. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of
                ...
                <div className={TermStyles.legalSections}>
                    ...
                    <p>                                        
                        You may be required to register to use the Services. You agree to keep your password confidential and will be responsible for all use of your account and password. We reserve the right
                ...
                <div className={TermStyles.legalSections}>
                    <h3>6. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h3>
                    <p>
                    ...
                    writing. YOU HEREBY AGREE TO THE USE OF ELECTRONIC SIGNATURES, CONTRACTS, ORDERS, AND OTHER RECORDS, AND ELECTRONIC DELIVERY OF NOTICES
                    POLICIES, AND RECORDS OF TRANSACTIONS INITIATED OR COMPLETED BY US OR VIA THE SERVICES. You hereby waive any rights or requirements under any statutes,
                    regulations, rules, ordinances, or other laws in any jurisdiction which require an original signature or delivery or retention of non-electronic records, or to payments or the granting of
                ...
                <div className={TermStyles.legalSections}>
                    ...
                    permissible by law. We may assign any or all of our rights and obligations to others at any time. We shall not be responsible or liable for any loss, damage, delay, or failure to act caused
                    by any cause beyond our reasonable control. If any provision or part of a provision of these Legal Terms is determined to be unlawful, void, or unenforceable, that provision or part of the
                    provision is deemed severable from these Legal Terms and does not affect the validity and enforceability of any remaining provisions. There is no joint venture, partnership, employment
                    or agency relationship created between you and us as a result of these Legal Terms or use of the Services. You agree that these Legal Terms will not be construed against us by virtue of
                    having drafted them. You hereby waive any and fences you may have based on the electronic of these Legal Terms and the lack of signing by parties hereto to execute
                    these Legal Terms.
                    </p>
                </div>
                ...
                <div className={TermStyles.legalSections}>
                    ...
                    <p>MAGMA LLC<br></br>
                    38 Park Avenue<br></br>
                    London E96 2TM<br></br>
